 ...
 * @author linjian 
 * @version 2.0
 * @create_date 2013-5-28 上午11:28:20
 */
public interface IHZ_Gas_CardMapper extends IHZ_BaseMapper<HZ_Gas_Card, Integer> {
	 ...
	 * @return
	 */
	public List<HZ_Gas_Card_Consumption_Log> getCardDetail(Map<String, Object> params);
	 ...
	 * @return 加油卡的上期卡余额
	 */
	public String getpre_balance(Map<String, Object> params);
	 ...
	 * @return 截止时间的加油卡余额
	 */
	public Map<String, Object> getMonthLastDayCardBalance(Map<String, Object> params);
	 ...
	 * @return 截止时间的加油卡总额
	 */
	public Map<String, Object> getMonthLastDayBalance(Map<String, Object> params);
}
